...
<table align=center>
  ...
  <tr><td><a href="https://malkiii.github.io/realtime-hooks/guide/useIntersection">useIntersection</a></td><td>Handles <code>IntersectionObserver</code> and returns the intersecting state (the element is in the view or not).</td></tr>
